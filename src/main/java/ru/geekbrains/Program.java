...
public class Program {
    ...
    private static final char DOT_EMPTY = ' '; // Признак пусток поля
    ...
    private static boolean checkWin(char c) {
        ...
        if (field[1][0] == c && field[1][0] == c && field[1][2] == c) return true;
        if (field[2][0] == c && field[2][1] == c && field[2][2] == c) return true;

        // Проверка по трём вертикалям
